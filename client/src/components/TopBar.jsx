  ...
  return (
    <div className="topbar  w-full flex items-center  justify-between py-3 md:py-6 px-4 bg-primary">
      <Link to="/" className="flex gap-2 items-center">
        <div className="p-1 md:p-2 bg-[#3c096c] rounded text-white">
          <PiPlugsConnectedThin />
        </div>
        <span className="text-xl md:text-2xl text-[#3c096c]  font-semibold">
          AlumnSphere
        </span>
      </Link>
      <div className="md:flex md:items-center">
        ...
        >
          ...
          <CustomButton
            title="Search"
            type="submit"
            containerStyles="bg-[#3c096c] text-white px-1.5 py-2.5 mt-2 rounded-r-full"
          />
        </form>
      </div>
      {/* Icons */}
